...
const Home = () => {
  ...
  const toggleCheckin = (event) => {
    ...
    if (isCheckinVisible) {
      ...
      Axios.post('https://internee-web.vercel.app/state', { email, state: "checkin", date: currentDate }) // Added date field
        .then(response => {
          console.log(response.data);
        })
        .catch(error => {
      ...
      Axios.post('https://internee-web.vercel.app/state', { email, state: "checkout", date: currentDate }) // Added date field
        .then(response => {
          console.log(response.data);
        })
        .catch(error => {
